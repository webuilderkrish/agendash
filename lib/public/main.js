...
module.exports = "<app-listing></app-listing>"
...
var ListingComponent = /** @class */ (function () {
    function ListingComponent(userData) {
        this.userData = userData;
        this.uData = [];
        this.displayedColumns = ['position', 'name', 'weight', 'symbol'];
        this.dataSource = this.uData;
    }
    ...
    ListingComponent.prototype.Filter = function (Value) {
...
module.exports = __webpack_require__(/*! /home/kepler/code/github/agendash/ui/src/main.ts */"./src/main.ts");
